...
$requestParameters['amazon_billing_agreement_id'] = "C03-6745301-9682017";
...
if ($_POST['action'] == 'authorize') {
    ...
    $requestParameters['amazon_billing_agreement_id'] = "C03-6745301-9682017";
    $requestParameters['mws_auth_token']              = null;
    $requestParameters['authorization_amount']        = $game_config['amount']; // authorization_amount
    ...
    $requestParameters['inherit_shipping_address']  = false;
    ...
    $requestParameters['access_token'] = $_SESSION['access_token'];
